...
class StudioPeerUser() : User {
    ...
    companion object {
        fun create(user: FirebaseUser): StudioPeerUser {
            ...
            return StudioPeerUser(user.uid, now, now, user.displayName!!, user.email!!)
        }
    }

    constructor(id: String, createdAt: Long, lastUpdatedAt: Long, name: String, email: String) : this() {
        this.id = id
